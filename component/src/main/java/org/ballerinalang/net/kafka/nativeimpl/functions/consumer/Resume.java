...
/**
 * Native function ballerina.net.kafka:resume resumes given paused partitions to continue receiving messages.
 */
@BallerinaFunction(packageName = "ballerina.net.kafka",
        ...
        isPublic = true)
public class Resume implements NativeCallableUnit { 
